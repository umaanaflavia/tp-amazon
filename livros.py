    ...
    for row in csv_reader:
        ...
        if "Frequentemente comprados juntos" in driver.page_source:
            ...
            for i in range(1, len(link_elements)):
                link_list.append(link_elements[i].find_element(By.TAG_NAME, "a").get_attribute('href'))
            ...
            with open(output_file, 'a', newline='', encoding='utf-8') as csv_file:
                ...
                csv_writer.writerow([url, book_description_content] + filtered_lines +  [link_list] + [link_titles])
        else:
