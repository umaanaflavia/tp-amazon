...
with open(link_file, 'r') as file:
    ...
    for row in csv_reader:
        ...
        # Check if the page contains the text "Clientes que compraram este item também compraram"
        if "Clientes que compraram este item também compraram" in driver.page_source:
            ...
            # Find the element with the class "_p13n-desktop-sims-fbt_fbt-desktop_new-thumbnail-box__36bD3"
            faceout_box = driver.find_element(By.CLASS_NAME, "p13n-sc-shoveler")
            # print(faceout_box.text)
